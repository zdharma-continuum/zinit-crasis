all: zplugin-crasis.plugin.zsh.zwc crasis.zwc -zcrasis-process-buffer.zwc themes/default.cr-theme.zwc themes/zdharma.cr-theme.zwc themes/zdharma-256.cr-theme.zwc themes/safari-256.cr-theme.zwc test
